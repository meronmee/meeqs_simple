...
import com.meronmee.core.api.annotation.Column;
...
public class DateServiceImpl implements DateService {
	...
	public <T extends Model> Map<String, Object> retrieveMap(Class<T> modelClass, Long modelId) {	
		...
		Map<String, Object> map = this.commonDao.findOne(DbConst.sqlKeyRetrieve, params);
	...
	public <T extends Model> List<Map<String, Object>> findMapByProperty(Class<T> modelClass, String propertyName, Object propertyValue){
		...
		List<Map<String, Object>> list = this.commonDao.find(DbConst.sqlKeyFindByProperty, params);
	...
	public <T extends Model> Map<String, Object> findOneMapByProperty(Class<T> modelClass, String propertyName, Object propertyValue){
		...
		Map<String, Object> map = this.commonDao.findOne(DbConst.sqlKeyFindOneByProperty, params);
	...
	public <T extends Model> List<Map<String, Object>> findMapByProps(Class<T> modelClass, Map<String, Object> params){
		...
		List<Map<String, Object>> list = this.commonDao.find(DbConst.sqlKeyFindByProps, sqlParams);
	...
	public <T extends Model> Map<String, Object> findOneMapByProps(Class<T> modelClass, Map<String, Object> params){
		...
		Map<String, Object> map = this.commonDao.findOne(DbConst.sqlKeyFindOneByProps, sqlParams);
	...
	public <T extends Model> int createModel(T model){
		...
		int okCount = this.commonDao.create(DbConst.sqlKeyCreate, params);
	...
	public <T extends Model> int updateModel(T model){
		...
		return this.commonDao.update(DbConst.sqlKeyUpdate, params);
	}
	...
	public <T extends Model> int deleteModel(T model){
		...
		return this.commonDao.update(DbConst.sqlKeyDelete, param);
	}
	/**
	 * 根据ID逻辑删除实体
	 * @param modelClass 实体类
	...
	public <T extends Model> int deleteModelByIds(Class<T> modelClass, List<Long> modelIds){
		...
		return this.commonDao.update(DbConst.sqlKeyDelete, params);
	}
	...
	public <T extends Model> int deleteModelPhysically(T model){
		...
		return this.commonDao.delete(DbConst.sqlKeyDeletePhysically, params);
	}
    ...
    private <T extends Model> T mapToModel(Class<T> modelClass, Map<String, Object> map){
        ...
        T model = ModelUtils.fromMap(modelClass, map);
        return model;
    }
    /**
     * 根据Map生成Model
