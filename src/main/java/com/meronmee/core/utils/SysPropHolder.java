...
/**
 * system.properties 配置文件读取工具
 * @author Meron
 *
 */
public class SysPropHolder {
    public static final Logger LOG = LoggerFactory.getLogger(SysPropHolder.class);  
    private static final String[] configFiles = {
			 "/config/system.common.properties" //src/main/resources/config/system.common.properties - 各环境公共的配置信息
    		,"/config/system.properties" //src/main/resources/config/system.properties - 各环境差异化的配置信息
	};  
