...
import com.meronmee.core.common.util.EncryptUtil;
import com.meronmee.core.web.constant.PasswordConst;
...
public class CustomCredentialsMatcher extends SimpleCredentialsMatcher {
	...
	protected boolean equals(Object tokenCredentials, Object accountCredentials){        
        ...
        //可以在此进行MD5等加密处理
        //String cryptedPassword = EncryptUtil.md5(inputPassword, PasswordConst.MESSAGE_DIGEST_SALT);
        String cryptedPassword = inputPassword;
